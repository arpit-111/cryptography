...
static void test_encrypt_ecb_verbose(void)
{
    ...
    // 128bit key
    uint8_t key[16]={ (uint8_t) 0x24, (uint8_t) 0x75, (uint8_t) 0xa2, (uint8_t) 0xb3,(uint8_t) 0x34,(uint8_t) 0x75,(uint8_t) 0x56, (uint8_t) 0x88, (uint8_t) 0x31, (uint8_t) 0xe2, (uint8_t) 0x12, (uint8_t) 0x00, (uint8_t) 0x13, (uint8_t) 0xaa, (uint8_t) 0x54, (uint8_t) 0x87 };
    // 512bit text
   // printf("enter key=");
    //for(int i=0;i<16;i++){
      //  scanf("%x%x%x%x",key[i]);
    //}
    uint8_t plain_text[16] = { (uint8_t) 0x00, (uint8_t) 0x04, (uint8_t) 0x12, (uint8_t) 0x14, (uint8_t) 0x12, (uint8_t) 0x04, (uint8_t) 0x12, (uint8_t) 0x00, (uint8_t) 0x0c, (uint8_t) 0x00, (uint8_t) 0x13, (uint8_t) 0x11, (uint8_t) 0x08, (uint8_t) 0x23, (uint8_t) 0x19, (uint8_t) 0x19};
